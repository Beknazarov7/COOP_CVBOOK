...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,.up.railway.app,healthcheck.railway.app,ucagraduatecvbook.org,.ucagraduatecvbook.org').split(',')
