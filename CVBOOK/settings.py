...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '.up.railway.app,localhost,127.0.0.1,healthcheck.railway.app,ucagraduatecvbook.org,.ucagraduatecvbook.org').split(',')
